...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default=str(root_dir / "data/open_nowcast/open_nowcast_results.xlsx"))
    parser.add_argument("--live-output", default=str(root_dir / "data/open_nowcast/open_nowcast_live.csv"))
    parser.add_argument("--state-output", default=str(root_dir / "data/open_nowcast/open_nowcast_state.csv"))
