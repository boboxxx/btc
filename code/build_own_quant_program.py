...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default=str(root_dir / "data/legacy/own_quant_program_results.xlsx"))
    parser.add_argument("--live-output", default=str(root_dir / "data/legacy/own_quant_live_signals.csv"))
    parser.add_argument("--ledger-output", default=str(root_dir / "data/legacy/own_quant_signal_ledger.csv"))
