...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="btc_signal_results.xlsx")
    parser.add_argument("--live-output", default="btc_live_signals.csv")
    parser.add_argument("--state-output", default="btc_signal_state.csv")
    parser.add_argument("--history-output", default="btc_signal_history.csv")
